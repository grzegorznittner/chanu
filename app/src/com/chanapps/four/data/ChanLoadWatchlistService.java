 ...
 *
 */
public class ChanLoadWatchlistService extends BaseChanService {
	private static final String TAG = ChanLoadWatchlistService.class.getName();

    protected static ChanDatabaseHelper chanDatabaseHelper;
    protected static InsertHelper insertHelper;

    public ChanLoadWatchlistService() {
   		super("board");
   	}

    protected ChanLoadWatchlistService(String name) {
   		super(name);
   	}
