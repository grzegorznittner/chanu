...
public class MobileProfile extends AbstractNetworkProfile {
    ...
    static {
        ...
        REFRESH_TIME.put(Health.VERY_SLOW, new FetchParams(150L, 10L, 20, 15, 50000, 5));
        REFRESH_TIME.put(Health.SLOW, new FetchParams(1200L, 10L, 20, 10, 100000, 10));
        REFRESH_TIME.put(Health.GOOD, new FetchParams(900L, 10L, 12, 8, 250000, 15));
        REFRESH_TIME.put(Health.PERFECT, new FetchParams(600L, 10L, 8, 4, 500000, 20));
    }
