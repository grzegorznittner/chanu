...
public class WifiProfile extends MobileProfile {
	...
	static {
		 ...
		 */
		REFRESH_TIME.put(Health.BAD,       new FetchParams(180L,  10L, 15, 10, 0, 0));
		REFRESH_TIME.put(Health.VERY_SLOW, new FetchParams(150L,  10L, 15, 10, 25000, 5));
		REFRESH_TIME.put(Health.SLOW,      new FetchParams(120L,  10L, 15,  7, 50000, 10));
		REFRESH_TIME.put(Health.GOOD,      new FetchParams(90L,  10L, 10,  4, 100000, 15));
		REFRESH_TIME.put(Health.PERFECT,   new FetchParams(60L,  10L,  6,  3, 250000, 20));
	}
